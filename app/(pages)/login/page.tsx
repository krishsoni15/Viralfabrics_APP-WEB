      ...
      <div className={`flex-1 lg:w-[45%] flex items-center justify-center pt-6 pb-6 px-6 sm:p-8 lg:p-10 xl:p-12 transition-all duration-300 relative overflow-visible rounded-t-[32px] lg:rounded-t-none -mt-8 lg:mt-0 z-20 shadow-[0_-12px_30px_rgba(0,0,0,0.04)] dark:shadow-[0_-12px_30px_rgba(0,0,0,0.18)] lg:shadow-none ${isDarkMode
        ...
        <div className="w-full max-w-sm lg:max-w-sm xl:max-w-md">
          ...
          <div className="text-center mb-8 lg:mb-12">
            <h3 className={`text-3xl sm:text-4xl lg:text-4xl font-bold mb-3 lg:mb-4 transition-colors duration-300 tracking-tight ${isDarkMode ? 'text-white' : 'text-slate-900'
              }`}>
              Welcome Back
            </h3>
            <p className={`text-lg sm:text-xl lg:text-xl transition-colors duration-300 font-medium ${isDarkMode ? 'text-slate-300' : 'text-slate-600'
              }`}>
          ...
          {showRememberMeAlert && (
            <div className={`mb-6 lg:mb-8 ml-8 p-4 lg:p-5 rounded-xl flex items-center space-x-3 shadow-lg w-full lg:w-80 xl:w-96 border-2 ${isDarkMode
              ...
              <div className={`p-2 rounded-full ${isDarkMode ? 'bg-blue-500/20' : 'bg-blue-100'
                ...
                <CheckCircleIcon className={`h-5 w-5 lg:h-6 lg:w-6 ${isDarkMode ? 'text-blue-400' : 'text-blue-600'
                  }`} />
              </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 lg:space-y-8 flex flex-col items-center">
            ...
            <div className="relative w-full lg:w-80 xl:w-96">
              <div className="relative transition-all duration-300">
                <div className={`absolute inset-y-0 left-0 pl-3 lg:pl-4 flex items-center pointer-events-none z-10 transition-colors duration-300 ${isDarkMode ? 'text-slate-400' : 'text-slate-500'
                  }`}>
            ...
            <div className="relative w-full lg:w-80 xl:w-96">
              <div className="relative transition-all duration-300">
                ...
                <button
                  ...
                  className={`absolute inset-y-0 right-0 pr-4 lg:pr-5 flex items-center z-10 transition-colors duration-300 ${isDarkMode ? 'text-slate-400 hover:text-slate-300' : 'text-slate-500 hover:text-slate-700'
                    }`}
                >
                  {isPasswordShown ? (
