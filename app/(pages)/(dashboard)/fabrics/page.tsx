...
export default function FabricsPage() {
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
      ...
      <div className={`mb-4 p-2 sm:p-3 rounded-lg border transition-all duration-150 animate-in fade-in-0 slide-in-from-top-2 ${
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex-1 min-w-[200px] flex items-center gap-2">
              ...
              <div className="relative">
                <select
                  ...
                  className={`px-3 py-2.5 rounded-lg border transition-all duration-150 hover:scale-[1.02] focus:scale-[1.02] text-sm appearance-none cursor-pointer input-focus ${
                    isDarkMode 
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-10 py-2.5 rounded-lg border transition-all duration-200 hover:scale-[1.01] focus:scale-[1.01] text-sm input-focus ${
                    filters.search
                      ? isDarkMode
            ...
            <div className="relative">
              <select
                ...
                className={`px-3 py-2.5 rounded-lg border transition-all duration-150 hover:scale-[1.02] focus:scale-[1.02] text-sm appearance-none cursor-pointer min-w-[140px] input-focus ${
                  isDarkMode 
                    ? 'bg-gray-700 border-gray-600 text-white focus:border-blue-500 hover:border-blue-400' 
                    : 'bg-white border-gray-300 text-gray-900 focus:border-blue-500 hover:border-blue-400'
                } focus:outline-none focus:ring-2 focus:ring-blue-500/20 pr-8`}
            ...
            {(filters.search || typeFilter || filters.weaver || filters.weaverQualityName) && (
              <button
                onClick={clearFilters}
                    className={`px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 hover:scale-105 active:scale-95 hover-lift ${
                  isDarkMode 
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex rounded-lg border overflow-hidden shadow-sm">
                  <button
                    ...
                    className={`px-3 py-2 text-sm font-medium transition-all duration-150 hover:scale-105 active:scale-95 ${
                      (filters.sortBy === 'createdAt' && filters.sortOrder === 'desc') || (filters.sortBy === 'createdAt' && !filters.sortOrder)
                        ? isDarkMode
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex rounded-lg border overflow-hidden shadow-sm">
                  <button
                    ...
                    className={`px-2 sm:px-3 py-2 text-sm font-medium transition-all duration-150 hover:scale-105 active:scale-95 flex items-center justify-center space-x-1 sm:space-x-2 ${
                      viewMode === 'table'
                        ? isDarkMode
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className={`px-4 py-2.5 rounded-lg font-semibold transition-all duration-150 hover:scale-105 active:scale-95 hover-lift text-sm shadow-md hover:shadow-lg whitespace-nowrap flex items-center space-x-2 ${
                  isDarkMode 
              ...
              <button
                ...
                disabled={loading}
                className={`group px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 shadow-sm hover:shadow-md hover:scale-105 active:scale-95 hover-lift whitespace-nowrap ${
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className={`px-3 py-1.5 rounded text-sm transition-all duration-150 hover:scale-105 active:scale-95 hover-lift ${
                    isDarkMode 
      ...
      <div className={`${viewMode === 'table' ? 'rounded-none border-0 shadow-none' : 'rounded-xl border shadow-lg'} overflow-hidden transition-all duration-150 animate-in fade-in-0 slide-in-from-top-4 delay-100 ${
        isDarkMode ? (viewMode === 'table' ? 'bg-transparent' : 'bg-gray-800 border-gray-700') : (viewMode === 'table' ? 'bg-white' : 'bg-white border-gray-200')
      }`}>
        ...
        {(loading || !initialFetchDone || fetchInFlight > 0 || initialLoading || !hasInitialFetchRef.current || 
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
              {filters.search || typeFilter || filters.weaver || filters.weaverQualityName ? (
                <>
                  <button
                    onClick={clearFilters}
                    className={`px-6 py-3 rounded-lg font-medium transition-all duration-200 hover:scale-105 shadow-md ${
                      isDarkMode
                ...
                <button
                  onClick={handleCreate}
                  className={`px-6 py-3 rounded-lg font-medium transition-all duration-200 hover:scale-105 shadow-md flex items-center space-x-2 ${
                    isDarkMode
                      ? 'bg-blue-600 text-white hover:bg-blue-700 hover:shadow-blue-500/50'
                      : 'bg-blue-500 text-white hover:bg-blue-600 hover:shadow-blue-500/50'
                  }`}
          ...
          <div>
            ...
            <div className={`px-3 sm:px-4 py-2 sm:py-3 border-b flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:items-center sm:justify-between transition-all duration-150 animate-in fade-in-0 slide-in-from-top-2 ${
              ...
              <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:items-center sm:space-x-3 lg:space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <select
                    ...
                    disabled={loading}
                    className={`px-2 sm:px-3 py-1 rounded-lg border text-xs sm:text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-150 hover:scale-[1.02] focus:scale-[1.02] input-focus ${
                      isDarkMode 
              ...
              {itemsPerPage !== 'All' && totalPages > 1 && (
                <div className="flex items-center space-x-1 sm:space-x-2">
                  <button
                    ...
                    className={`px-2 sm:px-3 py-1 rounded-lg text-xs sm:text-sm transition-all duration-150 hover:scale-105 active:scale-95 hover-lift shadow-sm hover:shadow-md ${
                        ...
                        for (let i = 1; i <= totalPages; i++) {
                          pages.push(
                            <button
                              ...
                              className={`px-2 sm:px-3 py-1 rounded-lg text-xs sm:text-sm transition-all duration-150 hover:scale-105 ${
                                currentPage === i
                          ...
                          for (let i = 2; i <= 5; i++) {
                            pages.push(
                              <button
                                ...
                                onClick={() => handlePageChange(i)}
                                disabled={isChangingPage || loading}
                              className={`px-2 sm:px-3 py-1 rounded-lg text-xs sm:text-sm transition-all duration-150 hover:scale-110 active:scale-95 hover-lift ${
                                currentPage === i
                                    ? isDarkMode ? 'bg-blue-600 text-white shadow-md' : 'bg-blue-500 text-white shadow-md'
                                    : isDarkMode ? 'bg-slate-700 text-slate-200 hover:bg-slate-600 border border-slate-600' : 'bg-white text-slate-700 hover:bg-blue-50 border border-slate-200'
                              } ${(isChangingPage || loading) ? 'opacity-50 cursor-not-allowed' : ''}`}
                  ...
                  <button
                    ...
                    className={`px-2 sm:px-3 py-1 rounded-lg text-xs sm:text-sm transition-all duration-150 shadow-sm hover:shadow-md ${
          ...
          <div className={`${viewMode === 'cards' ? 'p-4' : 'p-0'} animate-in fade-in-0 slide-in-from-top-4 duration-700`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
                {(() => {
                  ...
                  return groupOrder.map(qualityCode => {
                    ...
                    return (
                      <div key={qualityCode} className={`rounded-lg sm:rounded-xl border transition-all duration-300 ease-in-out hover:shadow-lg hover:scale-[1.02] animate-in fade-in-0 slide-in-from-bottom-2 ${
                        deletingQualityGroups.has(qualityCode)
                          ? isDarkMode 
                      ...
                      } ${fabrics.some(f => glowingIds.has(f._id)) ? 'animate-weaver-green-glow' : ''} ${
                        deletingQualityGroups.has(qualityCode) ? 'opacity-0 scale-95 blur-sm' : 'opacity-100 scale-100 blur-0'
                      }`} style={{ 
                              ...
                              {mainFabric.images && mainFabric.images.filter(img => img && img.trim() !== '').length > 1 && (
                                <>
                                  ...
                                  <button
                                    ...
                                    className={`absolute left-2 top-1/2 -translate-y-1/2 p-1.5 sm:p-2 rounded-full transition-all duration-150 ${
                                      isDarkMode
                                  ...
                                  <button
                                    ...
                                    className={`absolute right-2 top-1/2 -translate-y-1/2 p-1.5 sm:p-2 rounded-full transition-all duration-150 ${
                                      isDarkMode
                                        ? 'bg-gray-800/80 hover:bg-gray-700/90 text-white'
                                        : 'bg-white/90 hover:bg-white text-gray-700'
                                    } shadow-lg opacity-0 group-hover:opacity-100 hover:scale-110`}
                            ...
                            <div className={`p-2 sm:p-2.5 rounded-lg border ${
                              ...
                              <div className="space-y-2">
                                {itemsToShow.map((fabric, index) => (
                                  <div key={fabric._id} className={`p-2 sm:p-2.5 lg:p-3 rounded-lg border transition-all duration-300 ease-in-out relative overflow-hidden animate-in fade-in-0 slide-in-from-bottom-2 ${
                                    ...
                                    <div className="flex items-center justify-between mb-2 sm:mb-3">
                                      ...
                                      <div className="flex items-center gap-1 sm:gap-2">
                                        ...
                                        <button
                                          ...
                                          className={`p-1 sm:p-1.5 rounded-md transition-all duration-150 hover:scale-110 active:scale-95 hover-lift ${
                                            isDarkMode 
                                ...
                                {fabrics.length > 1 ? (
                                  <button
                                    ...
                                    className={`w-full py-1 sm:py-1.5 lg:py-2 text-xs sm:text-sm font-medium rounded border-2 border-dashed transition-all duration-150 hover:scale-[1.02] active:scale-95 ${
                                      isDarkMode 
                        ...
                        <div className={`p-1.5 sm:p-2 lg:p-3 border-t ${
                          ...
                          <div className="flex flex-col space-y-1.5 sm:flex-row sm:space-y-0 sm:space-x-1 lg:space-x-1.5 xl:space-x-2">
                            <button
                              ...
                              className={`flex-1 px-1.5 sm:px-2 lg:px-3 py-1 sm:py-1.5 lg:py-2 rounded-lg transition-all duration-150 hover:scale-110 active:scale-95 hover-lift text-xs sm:text-sm font-medium shadow-sm hover:shadow-md flex items-center justify-center space-x-1 bg-transparent ${
                                isDarkMode 
                            ...
                            <button
                              ...
                              className={`flex-1 px-1.5 sm:px-2 lg:px-3 py-1 sm:py-1.5 lg:py-2 rounded-lg transition-all duration-150 hover:scale-105 text-xs sm:text-sm font-medium shadow-sm hover:shadow-md flex items-center justify-center space-x-1 bg-transparent ${
                                isDarkMode 
                            ...
                            {false ? (
                              ...
                              <button
                                ...
                                disabled={false}
                                className={`flex-1 px-1.5 sm:px-2 lg:px-3 py-1 sm:py-1.5 lg:py-2 rounded-lg transition-all duration-150 hover:scale-105 text-xs sm:text-sm font-medium shadow-sm hover:shadow-md flex items-center justify-center space-x-1 bg-transparent disabled:opacity-50 disabled:cursor-not-allowed ${
                                  isDarkMode 
            ...
            <div className="overflow-x-auto w-full p-0 m-0" style={{ WebkitOverflowScrolling: 'touch', scrollbarWidth: 'thin' }}>
              <table className={`w-full min-w-[1100px] sm:min-w-[1300px] md:min-w-full text-[9px] xs:text-[10px] sm:text-xs md:text-sm border-2 border-collapse ${
                ...
                <thead className={`${
                  isDarkMode ? 'bg-gradient-to-r from-slate-800/80 to-slate-700/80 border-b border-slate-600' : 'bg-white border-b border-gray-300'
                }`}>
                  <tr>
                    ...
                    <th className={`px-1 sm:px-1.5 md:px-2 py-1.5 sm:py-2 md:py-3 text-center text-[9px] xs:text-[10px] sm:text-xs md:text-sm font-bold uppercase tracking-wide border-b-2 border-r whitespace-nowrap min-w-[60px] sm:min-w-[70px] ${
                      isDarkMode ? 'text-white border-slate-500 bg-slate-700/50' : 'text-black border-gray-300 bg-white'
                    }`}>
                      Weight
                    </th>
                    ...
                    <th className={`px-1 sm:px-1.5 md:px-2 py-1.5 sm:py-2 md:py-3 text-center text-[9px] xs:text-[10px] sm:text-xs md:text-sm font-bold uppercase tracking-wide border-b-2 border-r whitespace-nowrap min-w-[60px] sm:min-w-[70px] md:min-w-[80px] ${
                      isDarkMode ? 'text-white border-slate-500 bg-slate-700/50' : 'text-black border-gray-300 bg-white'
                    }`}>
                      Price
                    </th>
                    <th className={`px-1 sm:px-1.5 md:px-2 py-1.5 sm:py-2 md:py-3 text-center text-[9px] xs:text-[10px] sm:text-xs md:text-sm font-bold uppercase tracking-wide border-b-2 border-r whitespace-nowrap min-w-[60px] sm:min-w-[80px] md:min-w-[100px] ${
                      isDarkMode ? 'text-white border-slate-500 bg-slate-700/50' : 'text-black border-gray-300 bg-white'
                    }`}>
                      Rack
                    </th>
                  ...
                  {(() => {
                    ...
                    return groupOrder.map(qualityCode => {
                      ...
                      return fabrics.map((fabric, weaverIndex) => (
                        <tr key={`${qualityCode}-${fabric._id}`} className={`relative transition-all duration-300 hover:bg-opacity-50 animate-in fade-in-0 slide-in-from-left-2 ${weaverIndex === 0 ? '' : 'border-t-2'} ${weaverIndex === fabrics.length - 1 ? 'border-b-4' : ''} ${
                          ...
                          {weaverIndex === 0 && (
                            <td rowSpan={fabrics.length} className={`px-1.5 sm:px-2 md:px-3 lg:px-4 py-1.5 sm:py-2 md:py-3 align-top border-r border-b-4 ${
                              isDarkMode ? 'text-gray-300 border-gray-600 border-b-gray-500' : 'text-gray-900 border-gray-300 border-b-gray-300'
                            }`}>
                              <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                                <div className="text-[9px] xs:text-[10px] sm:text-xs md:text-sm">
                                  ...
                                  <span className={`ml-1 sm:ml-1.5 md:ml-2 font-bold text-[10px] xs:text-xs sm:text-sm md:text-base lg:text-lg ${
                                    isDarkMode ? 'text-blue-400' : 'text-blue-600'
                                  }`}>
                                    {mainFabric.qualityCode}
                                  </span>
                                ...
                                <div className="text-[9px] xs:text-[10px] sm:text-xs md:text-sm">
                                  ...
                                  <span className={`ml-1 sm:ml-1.5 md:ml-2 font-bold text-[9px] xs:text-[10px] sm:text-xs md:text-sm truncate block max-w-[100px] sm:max-w-[120px] md:max-w-none ${
                                ...
                                <div className="text-[9px] xs:text-[10px] sm:text-xs md:text-sm">
                                  ...
                                  <span className={`ml-1 sm:ml-1.5 md:ml-2 font-bold text-[9px] xs:text-[10px] sm:text-xs md:text-sm ${
                                    mainFabric.type 
                                ...
                                <div className="pt-1 sm:pt-1.5 md:pt-2 border-t-2 border-gray-400/30">
                                  <div className="text-[9px] xs:text-[10px] sm:text-xs md:text-sm">
                                    ...
                                    <span className={`ml-1 sm:ml-1.5 font-semibold text-[9px] xs:text-[10px] sm:text-xs ${
                          ...
                          {weaverIndex === 0 && (
                            <td rowSpan={fabrics.length} className={`px-1.5 sm:px-2 md:px-3 lg:px-4 py-1.5 sm:py-2 md:py-3 align-middle border-r border-b-4 ${
                              isDarkMode ? 'border-gray-600 border-b-gray-500' : 'border-gray-300 border-b-gray-300'
                            }`}>
                              <div className="flex justify-center items-center">
                                {mainFabric.images && mainFabric.images.filter(img => img && img.trim() !== '').length > 0 ? (
                                  <div className="flex flex-col items-center space-y-0.5 sm:space-y-1">
                                    <div className="relative">
                                      <img 
                                        ...
                                        alt="Fabric"
                                        className="w-16 h-12 xs:w-20 xs:h-14 sm:w-24 sm:h-20 md:w-32 md:h-24 lg:w-40 lg:h-28 xl:w-48 xl:h-36 object-cover rounded-lg border-2 cursor-pointer shadow-md hover:shadow-lg transition-all duration-150 hover:scale-105"
                                      ...
                                      />
                                      <div className={`hidden fallback-icon w-16 h-12 xs:w-20 xs:h-14 sm:w-24 sm:h-20 md:w-32 md:h-24 lg:w-40 lg:h-28 xl:w-48 xl:h-36 rounded-lg items-center justify-center border-2 ${
                                        isDarkMode ? 'bg-gray-600 border-gray-500' : 'bg-gray-100 border-gray-200'
                                      }`} style={{ display: 'none' }}>
                                        <PhotoIcon className={`h-5 w-5 xs:h-6 xs:w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 lg:h-10 lg:w-10 xl:h-12 xl:w-12 ${
                                          isDarkMode ? 'text-gray-400' : 'text-gray-500'
                                        }`} />
                                      </div>
                                    </div>
                                    {mainFabric.images && mainFabric.images.filter(img => img && img.trim() !== '').length > 1 && (
                                      <span className={`text-[8px] xs:text-[9px] sm:text-[10px] md:text-xs px-1.5 xs:px-2 py-0.5 rounded-full font-medium ${
                                        isDarkMode 
                                          ? 'bg-blue-600 text-white' 
                                  ...
                                  <div className={`w-16 h-12 xs:w-20 xs:h-14 sm:w-24 sm:h-20 md:w-32 md:h-24 lg:w-40 lg:h-28 xl:w-48 xl:h-36 rounded-lg flex flex-col items-center justify-center border-2 ${
                                    isDarkMode 
                                      ? 'bg-gray-700 border-gray-600' 
                                      : 'bg-gray-50 border-gray-200'
                                  }`}>
                                    <PhotoIcon className={`h-5 w-5 xs:h-6 xs:w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 lg:h-10 lg:w-10 xl:h-12 xl:w-12 mb-0.5 sm:mb-1 ${
                                      isDarkMode ? 'text-gray-400' : 'text-gray-500'
                                    }`} />
                                    <span className={`text-[8px] xs:text-[9px] sm:text-[10px] md:text-xs font-medium ${
                                      isDarkMode ? 'text-gray-500' : 'text-gray-400'
                                    }`}>
                                      No img
                                    </span>
                          ...
                          {/* W No. Column */}
                          <td className={`px-1 sm:px-1.5 md:px-2 py-1.5 sm:py-2 md:py-3 align-middle border-r ${
                            isDarkMode ? 'text-gray-300 border-gray-600' : 'text-gray-900 border-gray-300'
                          }`}>
                            <div className={`text-[10px] xs:text-xs sm:text-sm md:text-base font-bold text-center ${
                          ...
                          <td className={`px-1 sm:px-1.5 md:px-2 py-1.5 sm:py-2 md:py-3 align-middle border-r text-center ${
                            ...
                            <span className={`font-bold text-[9px] xs:text-[10px] sm:text-xs md:text-sm lg:text-base ${
                              fabric.greighRate > 0 
                                ? isDarkMode 
                                  ? 'text-green-400' 
                                  : 'text-green-600'
                          ...
                          <td className={`px-1 sm:px-1.5 md:px-2 py-1.5 sm:py-2 md:py-3 align-middle border-r text-center ${
                            ...
                            <div className="flex flex-col items-center justify-center space-y-1">
                              ...
                              <button
                                onClick={() => handleStickerDownload(fabric)}
                                  className={`p-1 xs:p-1.5 sm:p-2 rounded transition-all duration-150 hover:scale-110 active:scale-95 hover-lift ${
                                  isDarkMode 
                                    ? 'text-blue-400 border border-blue-500/30 hover:bg-blue-500/20' 
                                    : 'text-blue-600 border border-blue-300 hover:bg-blue-50'
                                }`}
                          ...
                          {weaverIndex === 0 && (
                            <td rowSpan={fabrics.length} className={`px-1 sm:px-1.5 md:px-2 lg:px-3 py-1.5 sm:py-2 md:py-3 align-middle border-b-4 ${
                              isDarkMode ? 'border-gray-600 border-b-gray-500' : 'border-gray-300 border-b-gray-300'
                            }`}>
                              <div className="flex flex-col justify-center space-y-1 sm:space-y-1.5 md:space-y-2">
                                <button
                                  onClick={() => handleView(mainFabric)}
                                  className={`w-full px-1.5 xs:px-2 sm:px-2.5 md:px-3 py-1 xs:py-1.5 sm:py-2 rounded-lg text-[9px] xs:text-[10px] sm:text-xs md:text-sm font-medium flex items-center justify-center space-x-1 transition-all duration-150 hover:scale-105 active:scale-95 hover-lift ${
                                    isDarkMode 
                                ...
                                <button
                                  onClick={() => handleEdit(mainFabric)}
                                  className={`w-full px-1.5 xs:px-2 sm:px-2.5 md:px-3 py-1 xs:py-1.5 sm:py-2 rounded-lg text-[9px] xs:text-[10px] sm:text-xs md:text-sm font-medium flex items-center justify-center space-x-1 transition-colors ${
                                    isDarkMode 
                                ...
                                {false ? (
                                  ...
                                  <button
                                    onClick={() => handleDeleteQualityGroup(mainFabric, fabrics)}
                                    disabled={false}
                                    className={`w-full px-1.5 xs:px-2 sm:px-2.5 md:px-3 py-1 xs:py-1.5 sm:py-2 rounded-lg text-[9px] xs:text-[10px] sm:text-xs md:text-sm font-medium flex items-center justify-center space-x-1 transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
                                      isDarkMode 
          ...
          {false && (
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              <button
                onClick={() => handlePageChange(Math.max(1, currentPage - 1))}
                disabled={currentPage === 1 || isChangingPage || loading}
                  className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-all duration-150 shadow-sm hover:shadow-md ${
                  currentPage === 1 || isChangingPage || loading
                      ? isDarkMode ? 'bg-slate-700 text-slate-500 cursor-not-allowed' : 'bg-slate-100 text-slate-400 cursor-not-allowed'
                      : isDarkMode ? 'bg-slate-700 text-slate-200 hover:bg-slate-600 border border-slate-600' : 'bg-white text-slate-700 hover:bg-blue-50 border border-slate-200'
                }`}
                ...
                {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={isChangingPage || loading}
                        className={`px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm transition-all duration-150 shadow-sm hover:shadow-md ${
                        currentPage === pageNum
                            ? isDarkMode ? 'bg-blue-600 text-white shadow-md' : 'bg-blue-500 text-white shadow-md'
                            : isDarkMode ? 'bg-slate-700 text-slate-200 hover:bg-slate-600 border border-slate-600' : 'bg-white text-slate-700 hover:bg-blue-50 border border-slate-200'
                      } ${(isChangingPage || loading) ? 'opacity-50 cursor-not-allowed' : ''}`}
      ...
      {showImageModal && (
        <div 
          className="fixed inset-0 backdrop-blur-sm bg-black/50 flex items-center justify-center p-4 modal-enter backdrop-enter"
          style={{ zIndex: Z_INDEX.MODAL }}
        >
          <div className={`max-w-4xl max-h-full rounded-xl overflow-hidden transition-all duration-150 modal-enter ${
            isDarkMode ? 'bg-gray-800' : 'bg-white'
          } shadow-2xl`}>
            {/* Modal Header */}
            <div className={`p-4 border-b ${
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`p-2 rounded-lg transition-all duration-150 hover:scale-110 active:scale-95 hover-lift ${
                    isDarkMode 
            ...
            <div className="relative">
              ...
              {showImageModal.fabric.images && showImageModal.fabric.images.length > 1 && (
                <>
                  <button
                    onClick={prevImage}
                    className={`absolute left-4 top-1/2 transform -translate-y-1/2 p-3 rounded-full transition-all duration-150 hover:scale-110 active:scale-95 hover-lift ${
                      isDarkMode 
      ...
      {showScrollToTop && (
        <button
          onClick={scrollToTop}
          className={`fixed bottom-6 right-6 z-40 w-9 h-9 rounded-full flex items-center justify-center shadow-lg transition-all duration-150 hover:scale-110 active:scale-95 scroll-to-top-btn ${
            isDarkMode
