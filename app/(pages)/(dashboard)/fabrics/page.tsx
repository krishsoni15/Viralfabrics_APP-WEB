          ...
          <div className={viewMode === 'table' ? '' : 'animate-in fade-in-0 slide-in-from-top-4 duration-500'}>
            ...
            {filteredAndSortedFabrics.length === 0 && fetchedDataOnce && hasInitialFetchRef.current && initialFetchDone && fetchInFlight === 0 ? (
              ...
              <div>
                ...
                <div className={`px-2 sm:px-3 md:px-4 py-2 sm:py-3 border-t flex flex-row items-center justify-between gap-2 transition-all duration-150 animate-in fade-in-0 slide-in-from-bottom-2 ${isDarkMode ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-gray-50'}`}>
                  <div className="flex flex-row items-center gap-2 sm:gap-3 lg:gap-4">
                    {/* Search result indicator */}
                    {filters.search && (
                      <div className={`px-2 py-1 rounded-lg text-[10px] sm:text-xs font-medium hidden sm:flex items-center gap-1.5 ${isDarkMode
