/**
 * Constants for GreyMaterials Module
...
// Valid greyMaterial types
export const GREY_MATERIAL_TYPES = [
  'Polyester',
  'Blend',
  'Viscose',
  'Cotton',
...
export type GreyMaterialType = typeof GREY_MATERIAL_TYPES[number];
