...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error checking grey info:', error);
    return NextResponse.json(errorResponse('Failed to check grey info'), { status: 500 });
  }
}
